...
class ParquetFile:
    ...
    def read_row_groups(
        self, row_groups, columns=..., use_threads=..., use_pandas_metadata=...
    ):
        """
...
class ParquetDataset:
    ...
    def schema(self):
        ...
        >>> import pyarrow.parquet as pq
        >>> pq.write_to_dataset(
        ...     table, root_path="dataset_v2_schema", partition_cols=["year"]
        ... )
    ...
    def read(self, columns=..., use_threads=..., use_pandas_metadata=...):
        ...
        >>> import pyarrow.parquet as pq
        >>> pq.write_to_dataset(
        ...     table, root_path="dataset_v2_read", partition_cols=["year"]
        ... )
    ...
    def fragments(self):  # -> list[Any]:
        ...
        >>> import pyarrow.parquet as pq
        >>> pq.write_to_dataset(
        ...     table, root_path="dataset_v2_fragments", partition_cols=["year"]
        ... )
    ...
    def files(self):
        ...
        >>> import pyarrow.parquet as pq
        >>> pq.write_to_dataset(
        ...     table, root_path="dataset_v2_files", partition_cols=["year"]
        ... )
...
def write_metadata(
    schema, where, metadata_collector=..., filesystem=..., **kwargs
):  # -> None:
    """
    ...
    **kwargs : dict,
    ...
    >>> import pyarrow.parquet as pq
    >>> pq.write_to_dataset(
    ...     table, "dataset_metadata", metadata_collector=metadata_collector
    ... )
...
def read_metadata(where, memory_map=..., decryption_properties=..., filesystem=...):
    ...
    >>> import pyarrow.parquet as pq
    >>> table = pa.table(
    ...     {"n_legs": [4, 5, 100], "animal": ["Dog", "Brittle stars", "Centipede"]}
    ... )
    >>> pq.write_table(table, "example.parquet")
