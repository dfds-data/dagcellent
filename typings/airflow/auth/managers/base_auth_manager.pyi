...
class BaseAuthManager(LoggingMixin):
    ...
    def is_authorized_configuration(
        ...
        *,
        ...
        details: ConfigurationDetails | None = ...,
        user: BaseUser | None = ...,
    ) -> bool:
        """
    ...
    def is_authorized_view(
        self, *, access_view: AccessView, user: BaseUser | None = ...
    ) -> bool:
        """
    ...
    def batch_is_authorized_connection(
        self, requests: Sequence[IsAuthorizedConnectionRequest]
    ) -> bool:
        """
    ...
    def batch_is_authorized_dag(
        self, requests: Sequence[IsAuthorizedDagRequest]
    ) -> bool:
        """
    ...
    def batch_is_authorized_pool(
        self, requests: Sequence[IsAuthorizedPoolRequest]
    ) -> bool:
        """
    ...
    def batch_is_authorized_variable(
        self, requests: Sequence[IsAuthorizedVariableRequest]
    ) -> bool:
        """
    ...
    def get_permitted_dag_ids(
        self,
        *,
        methods: Container[ResourceMethod] | None = ...,
        user=...,
        session: Session = ...,
    ) -> set[str]:
        """
