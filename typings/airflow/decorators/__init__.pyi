...
class TaskDecoratorCollection:
    ...
    @overload
    def branch(self, *, multiple_outputs: bool | None = ..., **kwargs) -> TaskDecorator:
    ...
    def run_if(
        self, condition: AnyConditionFunc, skip_message: str | None = ...
    ) -> Callable[[_T], _T]:
        """
